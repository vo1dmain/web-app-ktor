...
class GraduationDegreeEntity(id: EntityID<String>) : Entity<String>(id), HasModel<GraduationDegree> {
    companion object : EntityClass<String, GraduationDegreeEntity>(GraduationDegrees)
